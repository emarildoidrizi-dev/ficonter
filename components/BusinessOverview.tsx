  ...
  return (
    <section className={styles.shell}>
      <header className={styles.hero}>
        <div><span>FICONTER BUSINESS · OVERVIEW</span><AutoFitSingleLineText text={business.name} minSize={7} maxSize={62} safetyMargin={18} /><p>{business.business_type} · Base currency {business.base_currency}</p></div>
