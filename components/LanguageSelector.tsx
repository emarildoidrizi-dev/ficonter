...
export function LanguageSelector({
  ...
  const menu = open ? (
    <div
      ref={menuRef}
      className={`${styles.menu} ${useNativePhonePortal ? styles.mobilePortalMenu : ""}`}
      role="listbox"
  ...
  return (
    ...
    >
      ...
      {useNativePhonePortal && menu ? createPortal(menu, document.body) : menu}
