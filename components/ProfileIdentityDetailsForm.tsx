      ...
      <div style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
        ...
        <div>
          ...
          <p style={{ margin: "5px 0 0", opacity: .7, fontSize: 13 }}>
            Keep these details accurate. FICONTER may use them for account verification and authorized Vault recovery records.
          </p>
        </div>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(220px,1fr))", gap: 14 }}>
        ...
        <label style={labelStyle}>
          ...
          >
            ...
            {FICONTER_COUNTRIES.map((country) => (
        ...
        {feedback ? (
          <span
            ...
            style={{
              ...
              gap: 6,
              alignItems: "center",
              opacity: feedback.type === "success" ? 1 : .9,
            }}
          >
