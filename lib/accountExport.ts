...
class CanvasReport {
  ...
  private drawFooter(): void {
    ...
    context.textAlign = "left";
    context.fillText("Private account export - generated by FICONTER", MARGIN, PAGE_HEIGHT - 38);
    context.textAlign = "right";
  ...
  cover(summary: { label: string; value: string }[], email: string): void {
    this.createPage("Private account report");
    const context = this.context;

    context.fillStyle = COLORS.ink;
    context.font = "500 68px Georgia, serif";
    context.fillText("Private Financial", MARGIN, 235);
    context.fillText("Report", MARGIN, 310);
    ...
    context.fillText(email, MARGIN, 440);
    context.fillText(`Generated ${dateLabel(this.exportedAt, true)}`, MARGIN, 476);
    ...
    context.fillText("About this export", MARGIN + 32, 1362);
    context.fillStyle = COLORS.muted;
    context.font = "500 19px Arial, sans-serif";
    const privacy =
