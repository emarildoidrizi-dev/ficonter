...
export const GLOBAL_RUNTIME_TEMPLATES: Record<string, TemplateRow> = {
  ...
  "{0} percent of monthly budget used": row("{0} Prozent des Monatsbudgets genutzt", "{0} por ciento del presupuesto mensual utilizado", "{0} përqind e buxhetit mujor u përdor", "تم استخدام {0} بالمئة من الميزانية الشهرية", "{0} por cento do orçamento mensal utilizado", "{0} per cento del budget mensile utilizzato", "Использовано {0} процентов месячного бюджета"),
  "{0} of {1}": row("{0} von {1}", "{0} de {1}", "{0} nga {1}", "{0} من {1}", "{0} de {1}", "{0} di {1}", "{0} из {1}"),
  "{0} of {1} rows selected": row("{0} von {1} Zeilen ausgewählt", "{0} de {1} filas seleccionadas", "{0} nga {1} rreshta të zgjedhur", "تم تحديد {0} من أصل {1} صفوف", "{0} de {1} linhas selecionadas", "{0} di {1} righe selezionate", "Выбрано {0} из {1} строк"),
  ...
  "Recorded minimum · {0} still to pay · {1}": row("Gespeicherte Mindestzahlung · {0} noch zu zahlen · {1}", "Mínimo registrado · {0} pendiente · {1}", "Minimumi i regjistruar · {0} ende për t'u paguar · {1}", "الحد الأدنى المسجل · {0} متبقي للدفع · {1}", "Mínimo registado · {0} ainda por pagar · {1}", "Minimo registrato · {0} ancora da pagare · {1}", "Записанный минимум · {0} ещё к оплате · {1}"),
  ...
  "Financial health {0} out of 100": row("Finanzielle Gesundheit: {0} von 100", "Salud financiera: {0} de 100", "Shëndeti financiar: {0} nga 100", "الصحة المالية: {0} من 100", "Saúde financeira: {0} em 100", "Salute finanziaria: {0} su 100", "Финансовое здоровье: {0} из 100"),
