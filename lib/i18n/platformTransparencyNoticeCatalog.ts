...
Object.assign(LANDING_UI_TRANSLATIONS, {
  ...
  "FICONTER is available for everyday use and will continue to improve over time.": row(
    "FICONTER ist für den täglichen Gebrauch verfügbar und wird sich kontinuierlich weiterentwickeln.",
    "FICONTER está disponible para el uso diario y seguirá mejorando con el tiempo.",
    "FICONTER është i disponueshëm për përdorim të përditshëm dhe do të vazhdojë të përmirësohet me kalimin e kohës.",
    "FICONTER متاحة للاستخدام اليومي وستواصل التحسن مع مرور الوقت.",
    "A FICONTER está disponível para utilização diária e continuará a melhorar ao longo do tempo.",
    "FICONTER è disponibile per l'uso quotidiano e continuerà a migliorare nel tempo.",
    "FICONTER доступен для повседневного использования и будет продолжать совершенствоваться.",
  ),
  "Platform improvements are designed not to interfere with the financial data you add to your account.": row(
    "Verbesserungen der Plattform sind so konzipiert, dass sie die Finanzdaten, die Sie Ihrem Konto hinzufügen, nicht beeinträchtigen.",
    "Las mejoras de la plataforma están diseñadas para no interferir con los datos financieros que añades a tu cuenta.",
    "Përmirësimet e platformës janë krijuar që të mos ndërhyjnë në të dhënat financiare që shtoni në llogarinë tuaj.",
    "تم تصميم تحسينات المنصة بحيث لا تتداخل مع البيانات المالية التي تضيفها إلى حسابك.",
    "As melhorias da plataforma são concebidas para não interferir com os dados financeiros que adiciona à sua conta.",
    "I miglioramenti della piattaforma sono progettati per non interferire con i dati finanziari che aggiungi al tuo account.",
    "Улучшения платформы разработаны так, чтобы не затрагивать финансовые данные, которые вы добавляете в свой аккаунт.",
  ),
