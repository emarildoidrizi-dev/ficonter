-- FICONTER V7 — HARD Beta URL gate + invitation security for NEW + EXISTING customer accounts.
...
where table_schema = 'public'
  and table_name in ('beta_invite_codes', 'beta_signup_tokens', 'beta_user_entitlements')
order by table_name;
