...
const checks = [
  ...
  ["Normal entrance gives the brand about three seconds on screen", component.includes("STANDARD_DURATION_MS = 3200")],
  ["Reduced-motion entrance still remains visible for about two seconds", component.includes("REDUCED_MOTION_DURATION_MS = 2200")],
  ...
  ["Entrance fades instead of disappearing abruptly", css.includes("@keyframes entranceFade") && css.includes("2780ms forwards")],
