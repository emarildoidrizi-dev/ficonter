...
const checks = [
  ...
  ["components/ContactSupportModal.tsx", 'import { createPortal } from "react-dom"'],
  ["components/ContactSupportModal.tsx", "createPortal(modal, document.body)"],
  ["components/ContactSupportModal.module.css", "z-index: 2147483000"],
  ["components/ContactSupportModal.module.css", "background: rgba(7, 9, 11, 0.94)"],
