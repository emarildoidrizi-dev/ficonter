...
const personalSidebar = read("components/Sidebar.tsx");
...
assert(personalSidebar.includes("<LanguageSelector"), "Personal top-bar language selector is missing.");
assert(businessSidebar.includes("<LanguageSelector"), "Business top-bar language selector is missing.");
