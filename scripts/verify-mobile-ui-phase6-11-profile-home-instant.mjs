...
const checks = [
  ...
  ['home prefetch starts on pointer down', chrome.includes('onPointerDown={() => router.prefetch(PERSONAL_HOME_HREF)}')],
  ['home recognizes the real overview route', chrome.includes('pathname === PERSONAL_HOME_HREF || pathname === "/dashboard"')],
  ['home navigates directly without legacy redirect', chrome.includes('router.push(PERSONAL_HOME_HREF, { scroll: false })') && chrome.includes('const PERSONAL_HOME_HREF = "/dashboard/overview"')],
