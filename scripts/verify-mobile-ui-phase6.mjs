...
expect(chrome.includes("headerMark"), "New FICONTER header mark is missing.");
...
expect(chromeCss.includes("translate3d(0, 105%, 0)"), "More menu must enter as a bottom sheet.");
...
console.log("FICONTER mobile UI Phase 6: 24 full-shell/UI checks passed.");
